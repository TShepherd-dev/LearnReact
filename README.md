...
_Important The demo react project in here, even though it does run and operation, it is not meant to be a "proper" working application. It is just a collection of concepts, practice code and exercises. It is very loosely structured into a app-like structure but thats it._
